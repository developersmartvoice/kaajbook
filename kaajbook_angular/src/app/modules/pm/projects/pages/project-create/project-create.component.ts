...
export class ProjectCreateComponent implements OnInit {
	...
	autoTemplateTaskGenerate(projectId) {
 		...
 		let taskNameList = ['Task 1', 'Task 2', 'Task 3', 'Task 4', 'Task 5'];

		for (let Task = 0; Task < taskNameList.length; Task++) {
			this.createAutoGeneratedTaskForm = this.formBuilder.group({
				parent_task_id: [0],
				name: [taskNameList[Task], [Validators.required, Validators.maxLength(255)]],
