...
export class ProjectCreateComponent implements OnInit {
	...
	autoTemplateTaskGenerate(projectId) {
		...
		let selectedTemplate = this.createProjectForm.value.projectTemplateType_id;

		for (let Task = 0; Task < this.autoGeneratedTaskNameList[selectedTemplate].length; Task++) {
			this.createAutoGeneratedTaskForm = this.formBuilder.group({
				parent_task_id: [0],
				name: [this.autoGeneratedTaskNameList[selectedTemplate][Task], [Validators.required, Validators.maxLength(255)]],
			...
			this.taskService.create(this.createAutoGeneratedTaskForm.value)
			.subscribe(
				data => {
